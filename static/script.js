...
var queue = [];
var userid='';
userid = document.getElementById('hidden-name').innerText;
  ...
  message='You might have this';
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        message_container.innerHTML += `<div class="bot">${text1} ${message} </div>`;
        message_container.innerHTML += `<div class="bot">${description} ${reply2} ${reply3} ${text3}</div>`;
      }
    });
    while (queue.length) { 
      queue.pop(); 
