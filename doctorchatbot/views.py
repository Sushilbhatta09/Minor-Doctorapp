...
sym = pd.read_csv(r"C:\Users\samri\OneDrive\Desktop\Doctorchatbot\dataset\Symptom-severity.csv")
sym['Symptom'] = sym['Symptom'].str.replace('_',' ')
desc = pd.read_csv(r'C:\Users\samri\OneDrive\Desktop\Doctorchatbot\dataset\symptom_description.csv')
prev = pd.read_csv(r'C:\Users\samri\OneDrive\Desktop\Doctorchatbot\dataset\symptom_precaution.csv')
...
def create(request):
    ...
    return JsonResponse({'disease':disease,'precaution1':precaution1,'precaution2':precaution2,'precaution3':precaution3,'description':description})